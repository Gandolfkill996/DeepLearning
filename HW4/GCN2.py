...
class GCN2LayerNet(nn.Module):
    """2-layer GCN + global sum pooling + linear classifier"""
...
def train_model(
    ...
    model = GCN2LayerNet(in_dim, hidden_dim, num_classes).to(device)
...
def test_model(
    ...
    plt.title("GCN-2 layer ROC curves (One-vs-Rest)")
