...
# ============ Grid Search ============
def run_gridsearch(ModelClass, model_name="DNN_30_8"):
    ...
    # Only save DNN_30_8 best model
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    if model_name == "DNN_30_8":
...
# ============ Test Model ============
def test_model(ModelClass, model_name="DNN_30_8", new_data_path="cancer_reg-1.csv", model_path=None, params_path=None):
    import pandas as pd
    path = new_data_path
    data = Data(path)
    X, y = data.preprocess()
